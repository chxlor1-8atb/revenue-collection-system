      ...
      <div className="space-y-8 print:space-y-0 max-w-[210mm] mx-auto">
        {receipts.map(({ tx, house, invoices: txInvoices, senderName, paidVia, totalAmount, paidDate }, idx) => (
          <div
            ...
            className="bg-white pt-8 sm:pt-10 px-6 sm:px-12 pb-8 sm:pb-10 shadow-md print:shadow-none print:p-0 print:m-0 border border-slate-200/80 print:border-none relative break-after-page print:page-break-after-always overflow-hidden flex flex-col justify-between"
