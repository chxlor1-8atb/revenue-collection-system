      ...
      <div className="space-y-8 print:space-y-0 max-w-[210mm] mx-auto">
        {receipts.map(({ tx, house, invoices: txInvoices, senderName, paidVia, totalAmount, paidDate }, idx) => (
          <div
            ...
            className="bg-white p-6 sm:p-12 shadow-md print:shadow-none print:rounded-none min-h-[250mm] sm:min-h-[265mm] border border-slate-200/80 print:border-none relative break-after-page print:page-break-after-always overflow-hidden flex flex-col justify-between"
