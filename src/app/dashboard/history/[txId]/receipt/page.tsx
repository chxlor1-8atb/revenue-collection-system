  ...
  return (
    <div className="min-h-screen bg-slate-200 py-4 sm:py-8 font-sans print:bg-white print:py-0">
      ...
      <div 
        ...
        className="max-w-[210mm] min-h-[250mm] sm:min-h-[265mm] mx-auto bg-white p-6 sm:p-12 shadow-md print:shadow-none print:p-0 print:m-0 border border-slate-300 print:border-none relative overflow-hidden flex flex-col justify-between"
      >
        {/* Official Watermark */}
        ...
        <div className="relative z-10 flex flex-col h-full justify-between flex-1 gap-8">
          ...
          {/* Top Section: Header & Customer Info */}
          <div>
            {/* Header */}
          ...
          {/* Bottom Section: Notes, Signatures & Stamp */}
