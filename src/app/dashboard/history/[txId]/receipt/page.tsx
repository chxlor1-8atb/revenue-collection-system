  ...
  return (
    <div className="min-h-screen bg-slate-200 py-4 sm:py-8 font-sans print:bg-white print:py-0">
      ...
      <div 
        ...
        className="max-w-[210mm] min-h-[250mm] sm:min-h-[265mm] mx-auto bg-white pt-12 sm:pt-20 px-6 sm:px-14 pb-10 sm:pb-14 shadow-md print:shadow-none print:p-0 print:m-0 border border-slate-200/80 print:border-none relative overflow-hidden flex flex-col justify-between"
      >
        {/* Soft Watermark */}
