...
export default function TopNav({ userName }: { userName: string }) {
  ...
  return (
    <header className="border-b border-slate-100 bg-white rounded-t-[32px] px-6 md:px-8 lg:px-12 py-5">
      <div className="max-w-[1400px] mx-auto w-full flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <Link href="/dashboard/settings" className="w-10 h-10 rounded-full border border-slate-200 flex items-center justify-center text-slate-400 hover:bg-slate-50 hover:text-slate-700 transition-colors">
